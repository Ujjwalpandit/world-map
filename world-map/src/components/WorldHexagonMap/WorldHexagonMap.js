import styles from "./WorldHexagonMap.module.css";
import logo from '../../images/logo.png';
import activity1 from '../../images/activity-1@2x.png';
import crown from '../../images/crown-1@2x.png';
import purchase from '../../images/chart-1@2x.png';
import profile from '../../images/profile-1@2x.png';
import option from '../../images/option-1@2x.png';
import search from '../../images/icon-1@2x.png';
import indicator from '../../images/icons-2@2x.png';
import home from '../../images/icons-4@2x.png';
import detect from '../../images/icons-5@2x.png';
import business from '../../images/icons-6@2x.png';
import map from '../../images/hex-map-1@2x.png';
import details from '../../images/arow-1@2x.png';
import icons1 from '../../images/icons-1@2x.png';
import house from '../../images/icons-3@2x.png';
import arrow1 from '../../images/arrow-1@2x.png';
import arrow2 from '../../images/arrow-2@2x.png';
import arrow3 from '../../images/arrow-3@2x.png';
import arrow4 from '../../images/arrow-4@2x.png';
import arrow5 from '../../images/arrow-5@2x.png';
import arrow6 from '../../images/arrow-6@2x.png';
import progress1 from '../../images/—Pngtree—round progress bar_4705289.png';
import progress2 from '../../images/work-in-progress.png';
    ...
    <div className={styles.worldHexagonMap}>
      ...
      <div className={styles.navigationBar}>
        ...
        <div className={styles.search}>
          ...
          <img className={styles.icon} alt="" src={search} />
        </div>
      ...
      <div className={styles.sideIndicators}>
        <div className={styles.informerInfoWithIcon}>
          <img className={styles.icon1} alt="" src={activity1} />
        ...
        <div className={styles.informerInfoWithIcon}>
          <img className={styles.icon1} alt="" src={crown} />
          <div className={styles.info1}>
            <div className={styles.title1}>Sales</div>
            <div className={styles.amount}>
              <div className={styles.value3}>1,205,677</div>
              <div className={styles.indicator}>
                <img className={styles.upIcon} alt="" src="../up1.svg" />
                <div className={styles.div}>145</div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.informerInfoWithIcon}>
          <img className={styles.icon1} alt="" src={purchase} />
          <div className={styles.info1}>
            <div className={styles.title1}>Purchase</div>
            <div className={styles.amount}>
              <div className={styles.value3}>48,430,039</div>
              <div className={styles.indicator}>
                <img className={styles.upIcon} alt="" src="../up2.svg" />
                <div className={styles.div}>145</div>
              </div>
            </div>
          </div>
      ...
      <div className={styles.widgetMSizeBigCircleC}>
        <div className={styles.chart1}>
          ...
          {/* <img
            ...
            src="../background.svg"
          /> */}
          <img className={styles.progressIcon} alt="" src={progress2} />
        </div>
      ...
      <div className={styles.widgetMSizeBigCircleC1}>
        <div className={styles.chart1}>
          ...
          {/* <img
            ...
            src="../background.svg"
          /> */}
          <img className={styles.progressIcon1} alt="" src={progress1} />
        </div>
        <div className={styles.info4}>
      ...
      <div className={styles.mapPinPinWithName}>
        <div className={styles.tooltip}>
          <img className={styles.indicatorIcon} alt="" src={icons1} />
          <div className={styles.info1}>
            <div className={styles.title4}>Chicago</div>
            <div className={styles.amount5}>98,320,300</div>
          </div>
        </div>
        <img className={styles.arrowIcon} alt="" src={arrow1} />
      </div>
      <div className={styles.mapPinPinWithName1}>
        ...
        <img className={styles.arrowIcon} alt="" src={arrow6} />
      </div>
      <div className={styles.mapPinPinWithName2}>
        ...
        <img className={styles.arrowIcon} alt="" src={arrow2} />
      </div>
      <div className={styles.mapPinPinWithName3}>
        ...
        <img className={styles.arrowIcon} alt="" src={arrow3} />
      </div>
      <div className={styles.mapPinPinWithName4}>
        ...
        <img className={styles.arrowIcon} alt="" src={arrow4} />
      </div>
      <div className={styles.mapPinPinWithName5}>
        ...
        <img className={styles.arrowIcon} alt="" src={arrow5} />
      </div>
      <div className={styles.footer1}>
        <div className={styles.background} />
        <b className={styles.description}>Orion data visualisation</b>
      ...
      <div className={styles.title10}>
        ...
        <div className={styles.detail2}>
          ...
          <img className={styles.arowIcon} alt="" src={details}/>
        </div>
      </div>
